...
// 		             if(result=="1"){ 
// 		            	  alert("保存成功")
// 		                 location.href="../queryOne/${record.labDetailId}"
// 		            	 }else{
// 		            		 alert("保存失败")
// 		            	 }
...
// 		            }
// 		        });
	    document.getElementById("fom").action="../update";
			...
			<TD width="100%">
				...
				<legend>实验室添加</legend>
					  ...
					  <tr>
					    ...
					    <td width="41%"><input name="labDetailName" id="labDetailName" class="text" style="width:250px" type="text" size="40" value="${record.labDetailName}"/>
				        <span class="red"> *</span></td>
					    </tr>
					   <tr>
					    <td nowrap align="right">负责人:</td>
					    <td><input name="labDetailTeacher" id="labDetailTeacher" class="text" style="width:154px" value="${record.labDetailTeacher}"/>
					    <span class="red"> *</span></td>
					  </tr>
					  <tr>
					    <td nowrap align="right" height="120px">实验室说明:</td>
					    <td colspan="3"><textarea id="labDetailInstruction" name="labDetailInstruction"   rows="5" cols="80" >${record.labDetailInstruction}</textarea></td>
					    </tr>
					  </table>
			 <br />
				</fieldset>			</TD>
